...
class UI:
    ...
    def init(screen, scale):
        ...
        UI.descriptionfont = pg.font.Font(
            path('Fonts/DigitalDisco-Thin.ttf'), 14)
        ...
        UI.scale = scale
        UI.colors = {'blue': '#003264', 'light-blue': '#99ccff', 'black': '#000000',
                     'white': '#EBF7FE', 'red': '#780000', 'ice-blue': '#add8e61a'}
        UI.clock = pg.time.Clock()
        UI.FPS = 60

        UI.version = '0.6.0'  # antiga
